...
typedef struct {
  ...
  /**
   * Depending on hardware configuration, DDR initialization may not work
   * and/or not be necessary. Setting this to 1 disables this initialization.
   */
  int no_DDR_init;
 ...
 */
#define FLETCHER_AWS_SIM_CONFIG_DEFAULT {0, 2}
